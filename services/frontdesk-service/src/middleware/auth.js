...
const ROLE_FUNCS = {
  ADMIN:        ['triage.view','triage.create','checkin.view','checkin.manage','queue.manage','emergency.manage'],
  DOCTOR:       ['triage.view','queue.manage','emergency.manage'],
  NURSE:        ['triage.view','triage.create','checkin.view','nursing.notes'],
  RECEPTIONIST: ['triage.view','triage.create','checkin.view','checkin.manage','queue.manage','emergency.manage'],
};
